...
[**Enter-sthModuleScope**](#enter-sthmodulescope) - Функция входит в область указанного модуля, позволяя выполнять команды в области этого модуля.
...
[**Get-sthModuleScopeFunction**](#get-sthmodulescopefunction) - Функция возвращает список всех функций модуля, указанного в качестве значения параметра -Module, или модуля, в область которого был совершен вход при помощи функции Enter-sthModuleScope.
...
[**Get-sthModuleScopeVariable**](#get-sthmodulescopevariable) - Функция возвращает список всех переменных модуля, указанного в качестве значения параметра -Module,или модуля, в область которого был совершен вход при помощи функции Enter-sthModuleScope.
...
[**Get-sthScopeDepth**](#get-sthscopedepth) - Функция выводит расположение текущей области относительно глобальной.
